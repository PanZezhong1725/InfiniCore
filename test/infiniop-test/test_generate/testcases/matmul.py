...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        MatmulTestCase(
            np.random.rand(4, 5).astype(np.float16),
            None,
            np.random.rand(5, 6).astype(np.float16),
            None,
            np.random.rand(4, 6).astype(np.float16),
            None,
            1.0,
            0.0,
        ),
        ...
        MatmulTestCase(
            1e-2 * np.random.rand(1, 2048).astype(np.float16),
            None,
            1e-2 * np.random.rand(2048, 2048).astype(np.float16),
            None,
            1e-2 * np.random.rand(1, 2048).astype(np.float16),
            None,
            1.0,
        ...
        MatmulTestCase(
            1e-2 * np.random.rand(1, 2048).astype(np.float32),
            None,
            1e-2 * np.random.rand(2048, 2048).astype(np.float32),
            None,
            1e-2 * np.random.rand(1, 2048).astype(np.float32),
            None,
            1.0,
        ...
        MatmulTestCase(
            1e-2 * np.random.rand(2, 4, 2048).astype(np.float16),
            None,
            1e-2 * np.random.rand(2, 2048, 2048).astype(np.float16),
            None,
            1e-2 * np.random.rand(2, 4, 2048).astype(np.float16),
            None,
            1.0,
        ...
        MatmulTestCase(
            1e-2 * np.random.rand(2, 4, 2048).astype(np.float32),
            None,
            1e-2 * np.random.rand(2, 2048, 2048).astype(np.float32),
            None,
            1e-2 * np.random.rand(2, 4, 2048).astype(np.float32),
            None,
            1.0,
        ...
        MatmulTestCase(
            1e-2 * np.random.rand(6, 2048).astype(np.float32),
            None,
            1e-2 * np.random.rand(2048, 2560).astype(np.float32),
            None,
            1e-2 * np.random.rand(6, 2560).astype(np.float32),
            None,
            1.0,
            1.0,
        ),
        MatmulTestCase(
            np.random.rand(4, 48, 64).astype(np.float16),
            None,
            np.random.rand(4, 64, 6).astype(np.float16),
            None,
            np.random.rand(4, 48, 6).astype(np.float16),
            None,
            1.0 / 8,
            1.0,
        ),
        MatmulTestCase(
            np.random.rand(4, 48, 64).astype(np.float32),
            None,
            np.random.rand(4, 64, 6).astype(np.float32),
            None,
            np.random.rand(4, 48, 6).astype(np.float32),
            None,
            1.0 / 8,
            1.0,
        ),
