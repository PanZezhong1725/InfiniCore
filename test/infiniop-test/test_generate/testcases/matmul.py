...
if __name__ == "__main__":
    ...
    test_cases = [
        ...
        MatmulTestCase(
            np.random.rand(1, 2048).astype(np.float16),
            None,
            np.random.rand(2048, 2048).astype(np.float16),
            None,
            np.random.rand(1, 2048).astype(np.float16),
            None,
            1.0,
        ...
        MatmulTestCase(
            ...
            None,
            np.random.rand(2048, 2048).astype(np.float32),
            None,
            np.random.rand(1, 2048).astype(np.float32),
            None,
            1.0,
        ...
        MatmulTestCase(
            np.random.rand(2, 4, 2048).astype(np.float16),
            None,
            np.random.rand(2, 2048, 2048).astype(np.float16),
            None,
            np.random.rand(2, 4, 2048).astype(np.float16),
            None,
            1.0,
        ...
        MatmulTestCase(
            np.random.rand(2, 4, 2048).astype(np.float32),
            None,
            np.random.rand(2, 2048, 2048).astype(np.float32),
            None,
            np.random.rand(2, 4, 2048).astype(np.float32),
            None,
            1.0,
        ...
        MatmulTestCase(
            np.random.rand(6, 2048).astype(np.float32),
            None,
            np.random.rand(2048, 2560).astype(np.float32),
            None,
            np.random.rand(6, 2560).astype(np.float32),
            None,
            1.0,
            1.0,
        ),
