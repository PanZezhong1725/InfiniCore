...
public:
    infiniStatus_t use_mublas(MUstream stream, const Fn<mublasHandle_t> &f) const;
    infiniStatus_t use_mudnn(musaStream_t stream, const Fn<::musa::dnn::Handle &> &f) const;
};
